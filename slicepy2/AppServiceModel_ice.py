...
# <auto-generated>
#
# Generated from file `AppServiceModel.ice'
#
...
if 'AppServiceModel' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.AppServiceModel = Ice.createTempClass()
    class AppServiceModel(object):
        def __init__(self, serviceID=0, serviceStatus='', serviceName='', serviceAddrs=''):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.AppServiceModel):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_AppServiceModel)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_AppServiceModel = IcePy.defineStruct('::com::fastonz::fmserver::model::AppServiceModel', AppServiceModel, (), (
    ...
    _M_com.fastonz.fmserver.model.AppServiceModel = AppServiceModel
    del AppServiceModel
