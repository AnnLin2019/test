...
# <auto-generated>
#
# Generated from file `ConfRoomStartModel2.ice'
#
...
if 'ConfRoomStartModel2' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.ConfRoomStartModel2 = Ice.createTempClass()
    class ConfRoomStartModel2(object):
        def __init__(self, roomName='', maxUserCount=0, defaultMode='', useDefaultFlag=0, defaultVideoCodec='', defaultVideoWind='', defaultVideoQOS='', defaultVideoBitrate=0, defaultVideoQuality=0, enableUserList=0, result=0, layout='', companyID=0, super=0, presenter=0):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.ConfRoomStartModel2):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_ConfRoomStartModel2)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_ConfRoomStartModel2 = IcePy.defineStruct('::com::fastonz::fmserver::model::ConfRoomStartModel2', ConfRoomStartModel2, (), (
    ...
    _M_com.fastonz.fmserver.model.ConfRoomStartModel2 = ConfRoomStartModel2
    del ConfRoomStartModel2
