...
# <auto-generated>
#
# Generated from file `ConfRoomStartModel4.ice'
#
...
if 'ConfRoomStartModel4' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.ConfRoomStartModel4 = Ice.createTempClass()
    class ConfRoomStartModel4(object):
        def __init__(self, roomName='', maxUserCount=0, defaultMode='', useDefaultFlag=0, defaultVideoCodec='', defaultVideoWind='', defaultVideoQOS='', defaultVideoBitrate=0, defaultVideoQuality=0, enableUserList=0, result=0, layout='', companyID=0, super=0, presenter=0, videoPushType=0, videoNum=0, deptID=0, deptName='', companyName=''):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.ConfRoomStartModel4):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_ConfRoomStartModel4)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_ConfRoomStartModel4 = IcePy.defineStruct('::com::fastonz::fmserver::model::ConfRoomStartModel4', ConfRoomStartModel4, (), (
    ...
    _M_com.fastonz.fmserver.model.ConfRoomStartModel4 = ConfRoomStartModel4
    del ConfRoomStartModel4
