...
# <auto-generated>
#
# Generated from file `GatewayStatusModel.ice'
#
...
if 'GatewayStatusModel' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.GatewayStatusModel = Ice.createTempClass()
    class GatewayStatusModel(object):
        ...
        def __hash__(self):
            _h = 0
            _h = 5 * _h + Ice.getHash(self.number)
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.GatewayStatusModel):
                return NotImplemented
            else:
                if self.number is None or other.number is None:
                    if self.number != other.number:
                        return (-1 if self.number is None else 1)
                else:
                    if self.number < other.number:
                        return -1
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_GatewayStatusModel)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_GatewayStatusModel = IcePy.defineStruct('::com::fastonz::fmserver::model::GatewayStatusModel', GatewayStatusModel, (), (
        ('number', (), IcePy._t_string),
        ('status', (), IcePy._t_int)
    ))

    _M_com.fastonz.fmserver.model.GatewayStatusModel = GatewayStatusModel
    del GatewayStatusModel
