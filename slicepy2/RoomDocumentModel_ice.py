...
# <auto-generated>
#
# Generated from file `RoomDocumentModel.ice'
#
...
if 'RoomDocumentModel' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.RoomDocumentModel = Ice.createTempClass()
    class RoomDocumentModel(object):
        def __init__(self, docID='', roomID=0, parentID='', docName='', docType=0, fileName='', fileExt='', fileSize=0, checkCode=0, creatorID=0, fileWidth=0, fileHeight=0, subFileCount=0, fileURL='', fileServiceID=0, serviceAppID=0, serviceAddrs=''):
            self.docID = docID
            self.roomID = roomID
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.RoomDocumentModel):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_RoomDocumentModel)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_RoomDocumentModel = IcePy.defineStruct('::com::fastonz::fmserver::model::RoomDocumentModel', RoomDocumentModel, (), (
    ...
    _M_com.fastonz.fmserver.model.RoomDocumentModel = RoomDocumentModel
    del RoomDocumentModel
