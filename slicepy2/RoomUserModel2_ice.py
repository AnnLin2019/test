...
# <auto-generated>
#
# Generated from file `RoomUserModel2.ice'
#
...
if 'RoomUserModel2' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.RoomUserModel2 = Ice.createTempClass()
    class RoomUserModel2(object):
        def __init__(self, userID=0, userName='', displayName='', userRight='', userLevel='', seatList=0, nodeID=0, adminRole='', depID=0, sex='', telePhone='', mobile='', eMail='', role=''):
            self.userID = userID
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.RoomUserModel2):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_RoomUserModel2)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_RoomUserModel2 = IcePy.defineStruct('::com::fastonz::fmserver::model::RoomUserModel2', RoomUserModel2, (), (
        ('userID', (), IcePy._t_int),
    ...
    _M_com.fastonz.fmserver.model.RoomUserModel2 = RoomUserModel2
    del RoomUserModel2
