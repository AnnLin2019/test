...
# <auto-generated>
#
# Generated from file `TryAddTokenModel3.ice'
#
...
if 'TryAddTokenModel3' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.TryAddTokenModel3 = Ice.createTempClass()
    class TryAddTokenModel3(object):
        def __init__(self, tokenID='', nodeID='', roomID=0, userID=0, termianlType=0, userRight=0, productName='', userRole=0, ownerID=0, actorLicense=0, guestLicense=0, verifyMode=0, role=''):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.TryAddTokenModel3):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_TryAddTokenModel3)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_TryAddTokenModel3 = IcePy.defineStruct('::com::fastonz::fmserver::model::TryAddTokenModel3', TryAddTokenModel3, (), (
    ...
    _M_com.fastonz.fmserver.model.TryAddTokenModel3 = TryAddTokenModel3
    del TryAddTokenModel3
