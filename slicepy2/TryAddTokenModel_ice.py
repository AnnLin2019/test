...
# <auto-generated>
#
# Generated from file `TryAddTokenModel.ice'
#
...
if 'TryAddTokenModel' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.TryAddTokenModel = Ice.createTempClass()
    class TryAddTokenModel(object):
        def __init__(self, tokenID='', nodeID='', roomID=0, userID=0, termianlType=0, userRight=0, productName='', userRole=0, ownerID=0, actorLicense=0, guestLicense=0):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.TryAddTokenModel):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_TryAddTokenModel)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_TryAddTokenModel = IcePy.defineStruct('::com::fastonz::fmserver::model::TryAddTokenModel', TryAddTokenModel, (), (
    ...
    _M_com.fastonz.fmserver.model.TryAddTokenModel = TryAddTokenModel
    del TryAddTokenModel
