...
# <auto-generated>
#
# Generated from file `UserLoginRequestModel2.ice'
#
...
if 'UserLoginRequestModel2' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.UserLoginRequestModel2 = Ice.createTempClass()
    class UserLoginRequestModel2(object):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.UserLoginRequestModel2):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_UserLoginRequestModel2)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_UserLoginRequestModel2 = IcePy.defineStruct('::com::fastonz::fmserver::model::UserLoginRequestModel2', UserLoginRequestModel2, (), (
    ...
    _M_com.fastonz.fmserver.model.UserLoginRequestModel2 = UserLoginRequestModel2
    del UserLoginRequestModel2
