...
# <auto-generated>
#
# Generated from file `UserLoginRequestModel3.ice'
#
...
if 'UserLoginRequestModel3' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.UserLoginRequestModel3 = Ice.createTempClass()
    class UserLoginRequestModel3(object):
        def __init__(self, serviceID=0, roomID=0, userID=0, userName='', userType=0, terminalType=0, roomPassword='', userIP=''):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.UserLoginRequestModel3):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_UserLoginRequestModel3)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_UserLoginRequestModel3 = IcePy.defineStruct('::com::fastonz::fmserver::model::UserLoginRequestModel3', UserLoginRequestModel3, (), (
    ...
    _M_com.fastonz.fmserver.model.UserLoginRequestModel3 = UserLoginRequestModel3
    del UserLoginRequestModel3
