...
# <auto-generated>
#
# Generated from file `UserLoginRequestModel.ice'
#
...
if 'UserLoginRequestModel' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.UserLoginRequestModel = Ice.createTempClass()
    class UserLoginRequestModel(object):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.UserLoginRequestModel):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_UserLoginRequestModel)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_UserLoginRequestModel = IcePy.defineStruct('::com::fastonz::fmserver::model::UserLoginRequestModel', UserLoginRequestModel, (), (
    ...
    _M_com.fastonz.fmserver.model.UserLoginRequestModel = UserLoginRequestModel
    del UserLoginRequestModel
