...
# <auto-generated>
#
# Generated from file `UserLoginResponseModel2.ice'
#
...
if 'UserLoginResponseModel2' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.UserLoginResponseModel2 = Ice.createTempClass()
    class UserLoginResponseModel2(object):
        def __init__(self, displayName='', userRight=0, userLevel=0, callRight=0, seatList=0, nodeID=0, urole='', deptID=0, sex='', tel='', mobile='', email='', bindUserID=0, result=0, lastInsertID=0, role=''):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.UserLoginResponseModel2):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_UserLoginResponseModel2)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_UserLoginResponseModel2 = IcePy.defineStruct('::com::fastonz::fmserver::model::UserLoginResponseModel2', UserLoginResponseModel2, (), (
    ...
    _M_com.fastonz.fmserver.model.UserLoginResponseModel2 = UserLoginResponseModel2
    del UserLoginResponseModel2
