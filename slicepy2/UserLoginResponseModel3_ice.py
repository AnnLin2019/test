...
# <auto-generated>
#
# Generated from file `UserLoginResponseModel3.ice'
#
...
if 'UserLoginResponseModel3' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.UserLoginResponseModel3 = Ice.createTempClass()
    class UserLoginResponseModel3(object):
        def __init__(self, displayName='', userRight=0, userLevel=0, callRight=0, seatList=0, nodeID=0, urole='', deptID=0, sex='', tel='', mobile='', email='', bindUserID=0, result=0, lastInsertID=0):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.UserLoginResponseModel3):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_UserLoginResponseModel3)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_UserLoginResponseModel3 = IcePy.defineStruct('::com::fastonz::fmserver::model::UserLoginResponseModel3', UserLoginResponseModel3, (), (
    ...
    _M_com.fastonz.fmserver.model.UserLoginResponseModel3 = UserLoginResponseModel3
    del UserLoginResponseModel3
