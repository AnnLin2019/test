...
# <auto-generated>
#
# Generated from file `UserLoginResponseModel.ice'
#
...
if 'UserLoginResponseModel' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.UserLoginResponseModel = Ice.createTempClass()
    class UserLoginResponseModel(object):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.UserLoginResponseModel):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_UserLoginResponseModel)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_UserLoginResponseModel = IcePy.defineStruct('::com::fastonz::fmserver::model::UserLoginResponseModel', UserLoginResponseModel, (), (
    ...
    _M_com.fastonz.fmserver.model.UserLoginResponseModel = UserLoginResponseModel
    del UserLoginResponseModel
