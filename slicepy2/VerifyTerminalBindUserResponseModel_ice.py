...
# <auto-generated>
#
# Generated from file `VerifyTerminalBindUserResponseModel.ice'
#
...
if 'VerifyTerminalBindUserResponseModel' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.VerifyTerminalBindUserResponseModel = Ice.createTempClass()
    class VerifyTerminalBindUserResponseModel(object):
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.VerifyTerminalBindUserResponseModel):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_VerifyTerminalBindUserResponseModel)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_VerifyTerminalBindUserResponseModel = IcePy.defineStruct('::com::fastonz::fmserver::model::VerifyTerminalBindUserResponseModel', VerifyTerminalBindUserResponseModel, (), (
        ('verifyMode', (), IcePy._t_int),
        ('userRight', (), IcePy._t_int),
        ('result', (), IcePy._t_int)
    ))

    _M_com.fastonz.fmserver.model.VerifyTerminalBindUserResponseModel = VerifyTerminalBindUserResponseModel
    del VerifyTerminalBindUserResponseModel
