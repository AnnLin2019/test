...
# <auto-generated>
#
# Generated from file `VerifyUserModel.ice'
#
...
if 'VerifyUserModel' not in _M_com.fastonz.fmserver.model.__dict__:
    _M_com.fastonz.fmserver.model.VerifyUserModel = Ice.createTempClass()
    class VerifyUserModel(object):
        def __init__(self, userID=0, nickName='', role=0, result=0):
            self.userID = userID
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_com.fastonz.fmserver.model.VerifyUserModel):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_com.fastonz.fmserver.model._t_VerifyUserModel)

        __repr__ = __str__

    _M_com.fastonz.fmserver.model._t_VerifyUserModel = IcePy.defineStruct('::com::fastonz::fmserver::model::VerifyUserModel', VerifyUserModel, (), (
        ('userID', (), IcePy._t_int),
    ...
    _M_com.fastonz.fmserver.model.VerifyUserModel = VerifyUserModel
    del VerifyUserModel
